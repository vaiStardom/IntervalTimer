//
//  EditTimerIntervalTableViewCellActionsObjc.swift
//  IntervalTimer
//
...
@objc extension EditTimerIntervalTableViewCell {
    func swipe(recognizer: UIPanGestureRecognizer){
        ...
        if recognizer.state == .ended {
            ...
            if deleteOnSwipe {
                if swipeToDeleteDelegate != nil && intervalIndex != nil {
                    swipeToDeleteDelegate!.delete(index: intervalIndex!)
                }
